'''
Leetcode Daily Challenge: Middle of the Linked List
...
Runtime: 28 ms, faster than 61.37% of Python3 online submissions
for Middle of the Linked List.
Memory Usage: 13.7 MB, less than 7.14% of Python3 online submissions
for Middle of the Linked List.
